...
connection.connect(function(err){
    if (err){
        ...
        var app = express();
        //socket client
        require('./socket/server/home/ws.js');
        require('./socket/server/admin/ws_truong.js');
        require('./socket/server/admin/ws_getip.js');
        require('./socket/server/admin/ws_nganh.js');
        ...
        app.listen(8080,function(err){
            if(err){
                ...
                console.log("server dang chay vs port 8080...");
            }
        });
    }
});